...
import { getPropertyDetail } from "@/features/admin/properties/service";
import { PropertyReviewActions } from "@/features/admin/properties/components/property-review-actions";
...
export default async function AdminPropertyDetailPage({
  ...
  if (!session?.profileId || session.role !== "admin") {
    redirect("/login");
  }
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Card className="p-5">
            ...
            {buildingFacilities.length === 0 && unitAmenities.length === 0 ? (
              <EmptyNote>Nothing listed for this property.</EmptyNote>
            ) : (
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <Card className="p-5">
            ...
            <dl className="mt-3 space-y-2 text-sm">
              <SummaryRow label="Name" value={property.ownerName} />
              <SummaryRow label="Email" value={property.ownerEmail} />
            </dl>
          </Card>
