...
import { PROPERTY_TYPES } from "@/features/properties/schema";
            ...
            <div className="relative mt-16 text-center">
              ...
              <div className="mb-12 text-center">
                ...
                <p className="text-on-surface-variant mx-auto max-w-lg">
                  Thanks for listing with Omamie. Your property is now available
                  for matching with suitable tenants. We&apos;ll notify you when
                  ...
                  <div className="flex-grow">
                    <div className="mb-2">
                      <span className="bg-surface-container-high text-primary inline-block rounded-full px-3 py-1 text-xs font-semibold">
                        {
                          PROPERTY_TYPES[
                            property.property_type as keyof typeof PROPERTY_TYPES
                          ]
                        }
                      </span>
